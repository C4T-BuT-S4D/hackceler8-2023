...
class StaticJellyfish(Enemy):
    def __init__(
        ...
        super().__init__(
            coords,
            tileset_path="resources/enemies/static_jellyfish.tmx",
            name=name,
            damage=damage,
            respawn=respawn,
    ...
    def tick(self):
        ...
        self.shocking = (
            abs(self.game.player.x - self.x) < 70
            and abs(self.game.player.y - self.y) < 70
        )
        if self.shocking:
...
class MovingJellyfish(Enemy):
    def __init__(
        ...
        super().__init__(
            coords,
            tileset_path="resources/enemies/moving_jellyfish.tmx",
            name=name,
            damage=damage,
            respawn=respawn,
            respawn_ticks=respawn_ticks,
...
class EvilCamera(Enemy):
    def __init__(
        ...
        super().__init__(
            coords,
            tileset_path="resources/enemies/camera.tmx",
            name=name,
            damage=damage,
            respawn=respawn,
            respawn_ticks=respawn_ticks,
...
class Martian(Enemy):
    def __init__(
        ...
        super().__init__(
            coords,
            tileset_path="resources/enemies/martian.tmx",
            name=name,
            damage=damage,
            respawn=respawn,
            respawn_ticks=respawn_ticks,
