...
class Bullet(arcade.SpriteCircle):
    def __init__(
        self, system, x, y, speed, angle, radius=20, color=(255, 233, 0), soft=True
    ):
...
class SimpleBullet(Bullet):
    def __init__(
        ...
        super().__init__(
            system, x, y, speed, angle, radius=radius, color=color, soft=soft
        )
...
class PlayerBullet(SimpleBullet):
    def __init__(self, system, x, y, speed, angle, radius=15):
        super().__init__(
            system, x, y, speed, angle, radius=radius, color=(255, 233, 0), soft=False
        )
        self.intangible = False
        self.alpha = 255
        self.scale = 1
