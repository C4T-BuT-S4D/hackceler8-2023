...
class MusicNpc(Npc):
    ...
    def __init__(
        ...
        super().__init__(coords, name, walk_data, scale=1, tileset_path=tileset_path)
        self.id = id
    ...
    def dialogue(self):
        ...
        if MusicNpc.solved.get(self.id, False):
            self.display_textbox("Thanks again, your song changed my life!")
            return
        ...
        self.display_textbox(
            text, choices=["Ok", "Maybe Later"], process_fun=resp_process
        )
